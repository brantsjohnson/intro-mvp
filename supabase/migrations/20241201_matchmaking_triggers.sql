-- Triggers to automatically enqueue users for matchmaking when they join events or update profiles
...
-- 4) Cleanup function to remove stale queue entries
...
-- 6) Function to get detailed queue information
