...
import { offerAdvance, loadOnboardingContext } from "@/lib/onboarding/engine"
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { eventId, userId, currentNodeId = null, answer = null } = body || {}
    ...
    const result = await offerAdvance(supabase, ctx, { currentNodeId, answer })
