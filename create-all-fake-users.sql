-- Complete script to create all fake user data
-- Run this AFTER creating the 15 auth users in Supabase Dashboard
-- This script creates profiles, hobbies, expertise, and event data
